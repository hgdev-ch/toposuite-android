...
public class AddMeasureDialogFragment extends DialogFragment {
    ...
    Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(R.string.measure_add).setView(this.layout)
                ...
                }).setNegativeButton(R.string.cancel, (dialog, which) -> AddMeasureDialogFragment.this.listener.onDialogCancel(AddMeasureDialogFragment.this));
        Dialog dialog = builder.create();
        dialog.setOnShowListener(dialog1 -> {
            Button addButton = ((AlertDialog) dialog1).getButton(DialogInterface.BUTTON_POSITIVE);
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            throw new ClassCastException(activity + " must implement AddPointDialogListener");
        }
    }
