                ...
                addButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (AddPointWithRadiusDialogFragment.this.checkDialogInputs()) {
                            if (AddPointWithRadiusDialogFragment.this.radiusEditText.length() > 0) {
                                AddPointWithRadiusDialogFragment.this.radius =
                                        Double.parseDouble(AddPointWithRadiusDialogFragment.this
    ...
    private void initAttributes() {
        ...
        this.pointSpinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                ...
                if (AddPointWithRadiusDialogFragment.this.point.getNumber() > 0) {
